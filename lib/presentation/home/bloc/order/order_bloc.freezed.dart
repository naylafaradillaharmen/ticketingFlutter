...
class _$AddNominalPaymentImpl
    with DiagnosticableTreeMixin
    implements _AddNominalPayment {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'OrderEvent.addNominalPayment'))
      ..add(DiagnosticsProperty('nominalPayment', nominalPayment));
  }
...
class _$SuccessImpl with DiagnosticableTreeMixin implements _Success {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('paymentNominal', paymentNominal))
      ..add(DiagnosticsProperty('paymentMethod', paymentMethod))
      ..add(DiagnosticsProperty('cashierId', cashierId))
      ..add(DiagnosticsProperty('cashierName', cashierName));
  }
...
class _$ErrorImpl with DiagnosticableTreeMixin implements _Error {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'OrderState.error(errorMessage: $errorMessage)';
  }
